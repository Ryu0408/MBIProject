	...
	<hr>
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<span> > </span>
				<a href="${pageContext.request.contextPath }/guideBoard/guide/" style="text-decoration:none; color:black;">
				<span> 관광지 </span>
				</a>
			</div>
			<div class="col-sm-2"></div>
	...
	<div class="row">
		...
		<div class="col-sm-6 text-white" style="margin-top: 50px;">
			...
			<div class="paging" style="color: black; margin: auto; text-align: center;">
				<c:if test="${prev }">
					<a href="${pageContext.request.contextPath}/guideBoard/guide/${begin - 1}/">◀</a>
				</c:if>
				...
				<c:if test="${i != page }">
					<a href="${pageContext.request.contextPath}/guideBoard/guide/${i }/">
				 		[${i }]
					</a>
				</c:if>
				</c:forEach>
				<c:if test="${next }">
					<a href="${pageContext.request.contextPath}/guideBoard/guide/${end + 1}/">▶</a>
				</c:if>
			</div>
