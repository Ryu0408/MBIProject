	...
	<div class="row">
		...
		<div class="col-sm-6 text-white" style="margin-top: 50px;">
			...
			<div class="paging" style="color: black; margin: auto; text-align: center;">
				<c:if test="${prev }">
					<a href="${pageContext.request.contextPath}/noticeBoard/notice/${begin - 1}/">◀</a>
				</c:if>
				...
				<c:if test="${i != page }">
					<a href="${pageContext.request.contextPath}/noticeBoard/notice/${i }/">
				 		[${i }]
					</a>
				</c:if>
				</c:forEach>
				<c:if test="${next }">
					<a href="${pageContext.request.contextPath}/noticeBoard/notice/${end + 1}/">▶</a>
				</c:if>
			</div>
